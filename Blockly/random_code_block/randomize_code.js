...
Variablen
Funktionen
15:17:48.141	info	javascript.0 Stop script script.js.Alarmanlage.Codefeld_Final
15:17:48.184	info	javascript.0 Start javascript script.js.Alarmanlage.Codefeld_Final
15:17:48.184	info	javascript.0 script.js.Alarmanlage.Codefeld_Final: registered 12 subscriptions and 0 schedules
                              ...
                              <block type="timeouts_settimeout" id="fMZJ_`ePttZh8(!}%qXt" collapsed="true">
                                ...
                                <next>
                                  <block type="on_ext" id="j7I!`2}/I-|/heMaLLwW" inline="true" collapsed="true">
                                    ...
                                    <value name="OID0">
                                      <shadow type="field_oid" id="rK=lg!wQmj13Z,}u}Aer">
                                    ...
                                    <next>
                                      <block type="on_ext" id="yC/ukPKKp./e)_ig`hxU" inline="true" collapsed="true">
                                        ...
                                        <field name="ACK_CONDITION"></field>
                                        <value name="OID0">
                                          <shadow type="field_oid" id="Gn9}lAOko3j.}/09f,`{">
                                            <field name="oid">default</field>
                                          </shadow>
                                        ...
                                        <next>
                                          <block type="on_ext" id="2*yZv69/?I=d|%+wtWs|" collapsed="true">
                                            ...
                                            <field name="ACK_CONDITION"></field>
                                            <value name="OID0">
                                              <shadow type="field_oid" id="vCfeM-OeLWe(3vidphZe">
                                                <field name="oid">default</field>
                                              </shadow>
              ...
              <block type="control" id="k0G4;xQVE.Nv[jA]b!kv" collapsed="true">
                ...
                <next>
                  <block type="variables_set" id="LdgI/#%ucNGK5Nl`s4px" collapsed="true">
                    ...
                    <value name="VALUE">
                      <block type="convert_tostring" id="#4F.Z%8R:WIErF8=~sV}">
                        <value name="VALUE">
                          ...
                          <block type="controls_if" id="@Jl`Bv2/Z`C]q,?+`^2e">
                            ...
                            <value name="IF0">
                              <block type="logic_compare" id="RR^H[^SuUm!P~0)Iz;G3">
                                ...
                                <value name="B">
                                  <block type="convert_tostring" id="CnS^^eY[^@s%k)!kJ6pA">
                                    <value name="VALUE">
